 ...
 * File Name:   main.c
 *
 * Description: This is the source code for the PSOC Edge MCU Cryptography: SHA
...

  {
    ...
    case MESSAGE_NOT_READY:
      ...
      if (uart_status) {
         ...
         */
        if (ASCII_RETURN_CARRIAGE == message[msg_size]) {
          message[msg_size] = '\0';
    ...
    case MESSAGE_READY:
       ...
       * algorithm.
       */
      crypto_status = Cy_Crypto_Core_Sha(CRYPTO, message, msg_size, hash,

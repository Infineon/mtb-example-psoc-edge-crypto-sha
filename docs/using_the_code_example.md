...
The following example clones the "[Crypto SHA](https://github.com/Infineon/mtb-example-psoc-edge-crypto-sha)" application with the desired name "MySHA" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-crypto-sha --user-app-name MySHA --target-dir "C:/mtb_projects"
   ```
